...
export default function ProjectsSection() {
  return (
    <section className="max-w-5xl mx-auto px-6 pt-20 md:pt-15">
      <motion.h2 variants={sectionTitle} initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.4 }} className={`${abril.className} bg-[#efe4c8] text-center text-4xl md:text-5xl tracking-tight p-7 mb-3`}>
        PROJECT HEADLINE
      </motion.h2>

      {/* Bottom Border */}
      <motion.div variants={ruleLine} initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.4 }} className="border-t border-gray-400 origin-left" />
